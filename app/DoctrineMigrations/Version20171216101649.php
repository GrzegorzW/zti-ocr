 ...
 */
class Version20171216101649 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE UNIQUE INDEX search_idx ON answers (id)');
    }
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('DROP INDEX search_idx ON answers');
    }
}
